...
class TableHighlight(Base):
    ...
    columns: Mapped[list[int]] = mapped_column(ARRAY(Integer), nullable=False)
    note: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    document: Mapped["Document"] = relationship(back_populates="table_highlights")  # noqa: F821
...
class ImageHighlight(Base):
    ...
    document: Mapped["Document"] = relationship(back_populates="image_highlights")  # noqa: F821
